...
namespace Any.Core.Infrastructure
{
    ...
    public interface IEngine
    {
        ...
        void ConfigureServices(IServiceCollection services, IConfiguration configuration, AnyConfig nopConfig);
        ...
        /// <param name="nopConfig">Nop configuration parameters</param>
        void RegisterDependencies(ContainerBuilder containerBuilder, AnyConfig nopConfig);
    }
}
